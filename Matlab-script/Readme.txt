...
********************************
set_figure_style(scale): set the style for figures. Use latex font and interpreter. Use grey solid line for major grid and grey dotted line for minor grid. Font size is 8*scale for all texts. Default: scale = 2
resize_figure(scale, ratio): resize the current Matlab figure, width = 2.5 in * scale, and height = width*ratio. Default: scale = 2, ratio = 0.6
